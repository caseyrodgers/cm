...
ln -s ../../../hotmath2/web/jlibs target/cm-1.0-SNAPSHOT
...
ln -s ../../../hotmath2/web/help target/cm-1.0-SNAPSHOT
...
ln -s ~/dist/hotmath2/web/util/input_widgets target/cm-1.0-SNAPSHOT/util/input_widgets
