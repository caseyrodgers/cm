...
<html><!-- InstanceBegin template="/Templates/sub-page.dwt" codeOutsideHTMLIsLocked="false" -->
  ...
  <meta name="description" content="Catchup Math Basic Math Proficiency program reviews the course content covered in Algebra textbooks and is divided into six sections.">
  <meta name="keywords" content="Catchup math, Basic Math program, pre-test, review, quiz, prescription, lessons, videos, activities, practice, problems, tutorial, solutions">
<title>Catchup Math College Basic Math Proficiency Program</title>
<!-- InstanceEndEditable -->
...
<h1>College Basic Math Proficiency Program</h1>

<h2>Overview</h2>
<p>
  The Catchup Math College Basic Math Proficiency Program reviews the course content covered in college level
  Basic Math textbooks and is divided into <%= numberOfSectionsText %> sequential sections. Pre-tests (quizzes) are given for each
  section, and students are assigned lessons based on incorrect answers. Re-teaching includes text lessons
  (in both English and Spanish), videos, activities, and practice problems with tutorial solutions. A student
  takes repeat quizzes and receives lesson-prescriptions until passing each section. Teachers can review student
  work written on our online whiteboard.
</p>
