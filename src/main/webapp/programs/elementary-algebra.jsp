...
<html><!-- InstanceBegin template="/Templates/sub-page.dwt" codeOutsideHTMLIsLocked="false" -->
  ...
  <meta name="description" content="Catchup Math Algebra 2 Proficiency program reviews the course content covered in Algebra textbooks and is divided into six sections.">
  <meta name="keywords" content="Catchup math, Algebra 2 program, pre-test, review, quiz, prescription, lessons, videos, activities, practice, problems, tutorial, solutions">
<title>Catchup Math Elementary Algebra Proficiency Program</title>
<!-- InstanceEndEditable -->
...
<h1>College Elementary Algebra Proficiency Program</h1>

<h2>Overview</h2>
<p>
  The Catchup Math College Elementary Algebra Proficiency Program reviews the course content covered in college level
  Elementary Algebra textbooks and is divided into <%= numberOfSectionsText %> sequential sections.  Pre-tests (quizzes) are given for each section,
