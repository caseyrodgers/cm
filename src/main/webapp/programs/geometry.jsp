...
<html><!-- InstanceBegin template="/Templates/sub-page.dwt" codeOutsideHTMLIsLocked="false" -->
  ...
  <meta name="description" content="Catchup Math Geometry Proficiency program reviews the course content covered in Algebra textbooks and is divided into six sections.">
  <meta name="keywords" content="Catchup math, Geometry program, pre-test, review, quiz, prescription, lessons, videos, activities, practice, problems, tutorial, solutions">
<title>Catchup Math Geometry Proficiency Program</title>
<!-- InstanceEndEditable -->
...
<h1>Geometry Proficiency Program</h1>

<h2>Overview</h2>
<p>
  The Catchup Math Geometry Proficiency Program reviews the course content covered in Geometry
