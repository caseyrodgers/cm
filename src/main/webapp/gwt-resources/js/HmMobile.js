...
function getEwAdFrameMobile() {
    ...
    var adHtml = null;
    var adHtml = "<iframe style='margin-top: 10px' id='a3d1175f' name='a3d1175f' src='http://maxmedia.educationworld.com/www/delivery/afr.php?n=a3d1175f&amp;zoneid=" + _ZONE_MOBILE + "&amp;cb="
                    + randN
