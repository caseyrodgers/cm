...
var TutorManager = {
    ...
    installCustomSteps: function() {
    	try {
	        ...
	        var html = '<div style="display:none;" realstep="0" steprole="hint" class="hint" steptype="hint" id="stepunit-0"><div class="step_content"><p>Click the Resource button for review.</p></div></div>';
