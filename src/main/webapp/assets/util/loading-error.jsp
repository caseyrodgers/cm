...
<title>Catchup Math Loading Delayed</title>
<!-- InstanceEndEditable -->
...
String comment = String.format("CM Loading error: user_agent: %s,  IP: %s   cookies: %s", userAgent, ipAddress, cookieInfo); 
...
<style>
    /** Customize the fractal image position */
    #bd-right img{
        position: absolute;
        top: 30px;
        right: 90px;
...
<h1>Catchup Math Loading Problems</h1>
<p>
Catchup math failed to load due to network or computer related problems.  This problem has been logged and will be checked by our technical staff.  
</p>
<p style='margin: 20px;'>
<input type='button' value='Retry Loading Catchup Math' onclick='reloadCm();'/>
</p>
...
<!-- InstanceBeginEditable name="AfterCoreJavascript" -->
<script>
