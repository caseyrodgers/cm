...
import hotmath.gwt.cm_mobile.client.util.ObservableStackPopEvent;
import hotmath.gwt.cm_mobile.client.util.ObservableStackPushEvent;
import hotmath.gwt.cm_mobile.client.util.TouchClickEvent;
import hotmath.gwt.cm_mobile.client.util.ViewSettings;
	...
	private native void registerDomTransitionEndedEvent(Element element) /*-{
		try
		{
			...
			var callBack = function(e){
				instance.@hotmath.gwt.cm_mobile.client.HeaderPanel::onDomTransitionEnded()();
			};
