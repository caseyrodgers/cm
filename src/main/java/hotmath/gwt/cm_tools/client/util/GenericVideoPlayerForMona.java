...
public class GenericVideoPlayerForMona extends GenericVideoPlayer {
    ...
    static public enum MonaVideo {
        MOTIVATIONAL("/resources/videos/mona_motivational_video.flv", "Motivational Video"),
        PASS_QUIZ("/resources/videos/mona_congrats.flv","Congratulations" );
        
        private String title;
        private String file;
        
        MonaVideo(String title, String file) {
            this.title = title;
            this.file = file;
        }
