...
/**
 * CCSS Coverage for selected Custom Program
 */
public class CCSSCoverageImplCustomProgramPanel extends CCSSCoverageImplPanelBase {

    public CCSSCoverageImplCustomProgramPanel(CCSSCoverageImplBase base, int cpId) {
        super(base, cpId, 0);
    }
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.CUSTOM_PROG;
    }

	@Override
	public HTML getNoDataMessage() {
		return new HTML("<h1 style='color:#1C97D1; font-size:1.2em; margin:10px; padding:10px'>There is no CCSS Coverage data available for the selected Custom Program.</h1>");
	}
}
