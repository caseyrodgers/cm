...
public class CCSSCoverageImplStudentAssignedCompletedPanel extends CCSSCoverageImplPanelBase {
    public CCSSCoverageImplStudentAssignedCompletedPanel(CCSSCoverageImplBase base) {
        super(base);
    }
    ...
    protected ColumnModel<CCSSCoverageData> getColumns() { 
        ...
        ColumnConfig<CCSSCoverageData, String> column = new ColumnConfig<CCSSCoverageData, String>(_gridProps.ccssName(), 140, "Completed assignment CCSS coverage");
        column.setWidth(300);
        cols.add(column);
