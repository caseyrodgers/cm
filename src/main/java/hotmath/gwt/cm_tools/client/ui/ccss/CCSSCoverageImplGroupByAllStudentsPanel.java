...
/**
 * CCSS Coverage by all students in selected group
 */
public class CCSSCoverageImplGroupByAllStudentsPanel extends CCSSCoverageImplPanelBase {
    public CCSSCoverageImplGroupByAllStudentsPanel(CCSSCoverageImplBase base, int groupId, int adminId) {
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.GROUP_ALL_STUDENTS;
    }

	@Override
	protected HTML getNoDataMessage() {
		return new HTML("<h1 style='color:#1C97D1; font-size:1.2em; margin:10px; padding:10px'>No standards (CCSS) were covered by all students.</h1>");
	}
