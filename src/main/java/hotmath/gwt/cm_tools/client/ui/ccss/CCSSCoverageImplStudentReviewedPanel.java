...
public class CCSSCoverageImplStudentReviewedPanel extends CCSSCoverageImplPanelBase {
    ...
    public CCSSCoverageImplStudentReviewedPanel(CCSSCoverageImplBase base, int userId) {
        super(base, userId);
    }
	...
	public HTML getNoDataMessage() {
		return new HTML("<h1 style='color:#1C97D1; font-size:1.2em; margin:10px; padding:10px'>This student did not review any lessons.</h1>");
	}
}
