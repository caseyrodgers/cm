...
/**
 * CCSS Coverage for selected Assignment Problem (PID)
 */
public class CCSSCoverageImplProblemPanel extends CCSSCoverageImplPanelBase {

    public CCSSCoverageImplProblemPanel(CCSSCoverageImplBase base, String pid) {
        super(base, pid, 0);
    }
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.PID;
    }
