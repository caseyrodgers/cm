 ...
 */
public class CCSSCoverageImplGroupBy25to49PercentPanel extends CCSSCoverageImplPanelBase {
    public CCSSCoverageImplGroupBy25to49PercentPanel(CCSSCoverageImplBase base, int groupId, int adminId) {
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.GROUP_25_TO_49_PERCENT;
    }

	@Override
	protected HTML getNoDataMessage() {
		return new HTML("<h1 style='color:#1C97D1; font-size:1.2em; margin:10px; padding:10px'>No standards (CCSS) were covered by 25 to 49 percent of students.</h1>");
	}
