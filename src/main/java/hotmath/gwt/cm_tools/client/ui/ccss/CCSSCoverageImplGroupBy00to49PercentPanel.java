...
/**
 * CCSS Coverage by less than 50 percent of students in selected group
 */
public class CCSSCoverageImplGroupBy00to49PercentPanel extends CCSSCoverageImplPanelBase {
    public CCSSCoverageImplGroupBy00to49PercentPanel(CCSSCoverageImplBase base, int groupId, int adminId) {
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.GROUP_LT_50_PERCENT;
    }
