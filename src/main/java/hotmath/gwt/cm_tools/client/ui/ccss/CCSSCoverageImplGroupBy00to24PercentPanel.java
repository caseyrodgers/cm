...
/**
 * CCSS Coverage by less than 25 percent of students in selected group
 */
public class CCSSCoverageImplGroupBy00to24PercentPanel extends CCSSCoverageImplPanelBase {
    public CCSSCoverageImplGroupBy00to24PercentPanel(CCSSCoverageImplBase base, int groupId, int adminId) {
    ...
    public CCSSCoverageDataAction.ReportType getReportType() {
        return CCSSCoverageDataAction.ReportType.GROUP_LT_25_PERCENT;
    }

	@Override
	protected HTML getNoDataMessage() {
		return new HTML("<h1 style='color:#1C97D1; font-size:1.2em; margin:10px; padding:10px'>No standards (CCSS) were covered by less than 25 percent of students.</h1>");	}
