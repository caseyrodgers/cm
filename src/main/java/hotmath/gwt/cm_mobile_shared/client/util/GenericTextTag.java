...
public class GenericTextTag<E> extends Widget implements HasText {
	...
	private native void registerDomTouchEvents() /*-{
		var instance = this;
		var element = this.@hotmath.gwt.cm_mobile_shared.client.util.GenericTextTag::getElement()();

		element.ontouchstart = function(e){
				instance.@hotmath.gwt.cm_mobile_shared.client.util.GenericTextTag::onDomTouchStart()();
		};

		element.ontouchmove = function(e){
				instance.@hotmath.gwt.cm_mobile_shared.client.util.GenericTextTag::onDomTouchMove()();
		};

		element.ontouchend = function(e){
				instance.@hotmath.gwt.cm_mobile_shared.client.util.GenericTextTag::onDomTouchEnd()();
		};
	}-*/;
