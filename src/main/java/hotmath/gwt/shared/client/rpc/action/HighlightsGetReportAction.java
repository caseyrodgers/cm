...
public class HighlightsGetReportAction implements Action<CmList<HighlightReportData>> {
    ...
    public enum ReportType{GREATEST_EFFORT,LEAST_EFFORT,MOST_GAMES,NATIONWIDE_COMPARE,SCHOOL_COMPARE,MOST_QUIZZES_PASSED,AVERAGE_QUIZ_SCORES,FAILED_QUIZZES,FAILED_CURRENT_QUIZZES,COMPARE_PERFORMANCE};
}
