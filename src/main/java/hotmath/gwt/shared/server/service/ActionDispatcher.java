...
public class ActionDispatcher {
     ...
     * 
     *  An instance is created and the getActionType is called
    ...
    public <T extends Response> T execute(Action<T> action) throws CmRpcException {
        ...
        try {
            ...
            logger.info("RPC Action " + clazzName + " toString: " + action.toString() + " complete: elapsed time: " + (System.currentTimeMillis() - timeStart)/ 1000);
        }
    }
