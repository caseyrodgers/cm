...
public class HeaderPanel extends LayoutContainer {
	...
	public void setLoginInfo() {
        ...
        if(user != null) {
            String s = "Hello: <b>" + user.getUserName() + "</b>, you have viewed " + viewCount + " learning resources";
	...
	public void setHeaderInfo() {
		CatchupMath.showAlert("Set Header info");	
	}
	
	/* Set the header title for this context */
	public void setHeaderTitle(String title) {
	   // CatchupMath.showAlert("Set Header info: " + title);  
