...
import hotmath.gwt.cm_tools.client.CmLoginPanel;
 ...
 */
public class CatchupMath2 implements EntryPoint {
    static {
        publishNative();
    }
     ...
     * @return
     */
    public static CatchupMath2 getThisInstance() {
    ...
    static CatchupMath2 __thisInstance;
    ...
    public void onModuleLoad() {
        ...
        if(CmShared.getQueryParameter("login")!=null) {
        	RootPanel.get("loading").setVisible(false);
        	RootPanel.get("main-content").add(new CmLoginPanel());
        	return;
        }
    ...
    private void processLoginComplete(final Integer uid) {
        UserInfoDao.loadUser(uid, new CmAsyncRequest() {
    ...
    public void showQuizPanel_gwt() {
        ...
        GWT.runAsync(new CmRunAsyncCallback() {
            ...
            public void onSuccess() {
                ...
                _mainContainer.add(new CmMainPanel(new QuizCmGuiDefinition(-1)));
