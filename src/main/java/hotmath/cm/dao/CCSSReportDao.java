...
public class CCSSReportDao extends SimpleJdbcDaoSupport {
	...
	public List<CCSSCoverageData> getCCSSCoverageForLesson(String lessonFile) throws Exception {
    	String sql = CmMultiLinePropertyReader.getInstance().getProperty("GET_CCSS_COVERAGE_FOR_LESSON");
    	List<CCSSCoverageData> list = null;
    	try {
    		list = getJdbcTemplate().query(sql, new Object[] { lessonFile }, new RowMapper<CCSSCoverageData>() {
    			@Override
    			public CCSSCoverageData mapRow(ResultSet rs, int rowNum) throws SQLException {
    				CCSSCoverageData data = new CCSSCoverageData(rs.getString("lesson"), rs.getString("standard_name_new"));
    				return data;
    		...
    		LOGGER.error(String.format("getCCSSCoverageForLesson(): lessonFile: %s", lessonFile), e);
    		throw e;
    	}
    	if (list == null) list = new ArrayList<CCSSCoverageData>();
    	return list;
	...
	public List<CCSSCoverageData> getCCSSCoverageForPID(String pid) throws Exception {
    	...
    	List<CCSSCoverageData> list = null;
    	try {
    		list = getJdbcTemplate().query(sql, new Object[] { pid }, new RowMapper<CCSSCoverageData>() {
    			@Override
    			public CCSSCoverageData mapRow(ResultSet rs, int rowNum) throws SQLException {
    				CCSSCoverageData data = new CCSSCoverageData(rs.getString("lesson"), rs.getString("standard_name_new"));
    				return data;
    		...
    		LOGGER.error(String.format("getCCSSCoverageForPID(): lessonFile: %s", pid), e);
    		throw e;
    	}
    	if (list == null) list = new ArrayList<CCSSCoverageData>();
    	return list;
	...
	public List<CCSSCoverageData> getCCSSCoverageForCustomProgram(int cpId) throws Exception {
    	String sql = CmMultiLinePropertyReader.getInstance().getProperty("GET_CCSS_COVERAGE_FOR_CUSTOM_PROG");
    	List<CCSSCoverageData> list = null;
    	try {
    		list = getJdbcTemplate().query(sql, new Object[] { cpId }, new RowMapper<CCSSCoverageData>() {
    			@Override
    			public CCSSCoverageData mapRow(ResultSet rs, int rowNum) throws SQLException {
    				CCSSCoverageData data = new CCSSCoverageData(rs.getString("lesson"), rs.getString("standard_name_new"));
    				return data;
    		...
    		LOGGER.error(String.format("getCCSSCoverageForCustomProgram(): cpId: %d", cpId), e);
    		throw e;
    	}
    	if (list == null) list = new ArrayList<CCSSCoverageData>();
    	return list;
