...
public class HaTestDao {
	 ...
	 * @throws Exception
	 */
	public static void saveTestQuestionChange(final Integer testId, String pid, int answer, boolean isCorrect) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static List<HaTestRunResult> getTestCurrentResponses(final Connection conn, final Integer testId) throws Exception {
	 ...
	 * @throws HotMathException
	 */
	public static HaTestRun createTestRun(final Connection conn, Integer studentUid, Integer testId, String wrongGids[],
