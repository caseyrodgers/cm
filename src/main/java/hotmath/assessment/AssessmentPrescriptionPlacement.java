...
public class AssessmentPrescriptionPlacement extends AssessmentPrescription {
    ...
    /** Create placement prescription that simply moves user
        to next test in sequence.
        
        If user missed 2 or more in any segment, then automatically
        enroll them into that Program ... otherwise, move to next segment.
